...
import 'package:book_meter/presentation/author_title/author_book_model.dart';


class AuthorBookPage extends StatelessWidget{
  final name;
  AuthorBookPage({this.name});
  ...
  Widget build(BuildContext context){
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<AuthorBookModel>(
          //create: (context) => BottomNavigationBarProvider(),
          create: (_) => AuthorBookModel(),
  ...
  Future deleteBook(
    ...
    AuthorBookModel model,
    Book book,
  )async{
    try{
      await model.deleteBook(book);
      //await model.authorBooks();
    }catch(e){
